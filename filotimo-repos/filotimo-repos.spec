...
Source600:      _copr:copr.fedorainfracloud.org:sentry:kernel-fsync.repo
Source601:      _copr:copr.fedorainfracloud.org:tduck973564:filotimo-packages.repo
Source602:      rpmfusion-free.repo
Source603:      rpmfusion-free-updates.repo
Source604:      rpmfusion-free-updates-testing.repo
...
Source26:       RPM-GPG-KEY-fedora-16-secondary%global rawhide_release 41
%global updates_testing_enabled 0
...
Requires:       filotimo-repos = %{version}-%{release}
...
%package archive
Summary:        Filotimo updates archive package repository
Requires:       filotimo-repos = %{version}-%{release}
...
for file in %{_sourcedir}/*.repo ; do
...
# Make sure releasever is populated with actual release version of fedora for copr
